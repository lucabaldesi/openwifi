...
cp $WORKDIR/80211.patch $KDIR/
cd $KDIR
git apply 80211.patch

make $KDIR/net/mac80211/mac80211.ko
cp $KDIR/net/mac80211/mac80211.ko $WORKDIR -rf

make $KDIR/net/wireless/cfg80211.ko
cp $KDIR/net/wireless/cfg80211.ko $WORKDIR -rf
